...
// interaction
camera.pivot "坐标原点"
camera.doubleTapMesh "双击网格"
camera.doubleTapBackground "双击背景"
camera.doubleTapPivot "双击后改变"
camera.doubleTapPivot.help "双击后改变坐标原点"
...
file.export.gltfExtraPaint.help "将导出粗糙度、金属性、蒙版和图层绘画。其他软件不会读取该属性"

// obj
file.export.obj "导出 OBJ 格式"
file.export.objWarning "图层与其他属性（如粗糙度、金属性、蒙版和图层绘画）将会丢失。"
